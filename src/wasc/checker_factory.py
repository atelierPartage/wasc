...
checker_factory.register("DFTT03", dft.DFTT03)
checker_factory.register("DFTT04", dft.DFTT04)
checker_factory.register("DFTT05", dft.DFTT05)
checker_factory.register("DFTT06", dft.DFTT06)
checker_factory.register("DFTT07", dft.DFTT07)
